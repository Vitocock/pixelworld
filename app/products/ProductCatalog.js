export default function ProductCatalog({ Product, onOpen, color }) {
  ...
  return (
    <div
      style={{ borderColor }}
      className="flex flex-col w-[46%] lg:w-1/5 p-4 lg:h-[32rem] border-2 transition-colors duration-500 
    ...
    >
      ...
      <div className="mt-4">
        ...
        <h1 className="font-['orbitron'] leading-none text-base lg:text-2xl line-clamp-2 break-words min-h-[3rem]">{name}</h1>
      </div>
