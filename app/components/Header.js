  ...
  return (
    <header className="flex w-full flex-row justify-center lg:py-2 bg-black fixed top-0 transition-all z-30">
      <nav className="flex w-[90%] 2xl:w-2/3 justify-between items-center">
        <a className="items-start lg:items-center hover:scale-110 transition-all duration-300" href="">
        ...
        <a className="hidden w-52 h-10 px-9 py-3 rounded-md scroll-stroke 2xl:inline-flex flex-col justify-center items-center self-center transform hover:scale-105 transition-all duration-300" href="#contact">
      ...
      <nav className={`2xl:hidden fixed right-0 h-full bg-black/90 mt-16 z-20 transition-all duration-500 overflow-hidden ${mobileOpen ? "max-w-[32rem]" : "max-w-0"}`}>
