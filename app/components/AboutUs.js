export default function AboutUs () {
    return (
        <section className="my-12 flex flex-wrap flex-col w-full lg:w-4/5 justify-self-center text-white snap-y snap-always">
            <div className="flex snap-start">
                <h2 id="about-us" className="scroll-mt-24 w-full mb-8 text-center justify-start text-white text-4xl lg:text-5xl font-bold font-['Orbitron'] [text-shadow:_0px_0px_30px_rgb(4_217_255_/_1.00)]">Quienes Somos</h2>
            </div >
