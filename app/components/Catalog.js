...
export default function Catalog({catalogUrl}) {
  ...
  return (
    <section className="h-[36rem] lg:h-dvh py-12 grid grid-cols-4 sm:grid-cols-5 grid-rows-1 overflow-hidden">
      ...
      {catalogUrl && (
        <p className="mb-4 absolute flex justify-self-center self-end transform hover:scale-105 transition-all duration-300 z-20">
          <a
