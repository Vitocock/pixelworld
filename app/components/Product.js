...
export default function Products() {
  ...
  return (
    <section className="w-full lg:w-5/6 my-16 flex flex-col justify-self-center justify-center">
      ...
      <div className="flex flex-col lg:flex-row w-full lg:w-4/5 lg:h-96 px-14 py-6 self-center items-center gap-8 lg:gap-44 overflow-x-auto bg-[radial-gradient(ellipse_127.02%_151.92%_at_15.32%_21.04%,_rgba(164.69,_238.74,_255,_0.20)_0%,_rgba(109.97,_190.80,_244.37,_0.04)_77%,_rgba(69.95,_144.07,_212.50,_0)_100%)] shadow-[2px_16px_19px_0px_rgba(0,0,0,0.09)] scroll-stroke transition-all duration-300 backdrop-blur-3xl">
        {products.length > 0 ? (
